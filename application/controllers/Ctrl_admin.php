...
class Ctrl_admin extends CI_Controller {
	...
	public function registrar(){
		...
		$this->Mdl_admin->registro_columnistas($parametros);
	}
	...
	public function modificar(){
		...
		$this->Mdl_admin->modificar_registro($parametros);
	}

	public function eliminar_registro(){
		$cid_usuario=$this->input->post('vid_usuario');
		$this->Mdl_admin->eliminar($cid_usuario);
	}

	public function tabla_columinstas(){
		echo json_encode($this->Mdl_admin->obtener_registros());		
	}
	public function buscar(){
		$name_colum=$this->input->post('vname_user');
		echo json_encode($this->Mdl_admin->buscar_registro($name_colum));	
	}
}
